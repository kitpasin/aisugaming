...
function CharactersPage({ domain }) {
  ...
  useEffect(() => {
    getCharacters().then(() => setLoading(false))
    getStars();
    getElements();
    getPaths();
  }, []);
        ...
        <div className="w-full p-8 overflow-y-auto">
          <div className="w-full max-w-[1536px] m-auto text-white text-xl font-bold">
            ...
            <div
              data-aos="fade-right"
              data-aos-duration="1000"
              className="mt-12 capitalize border-b-[1px] border-[#33343a] w-full flex items-center gap-4 max-md:text-[16px] max-xs:text-sm"
            >
              <p className="border-b-[5px] w-fit">
                {location.pathname.split("/")[2]}
              </p>
              <p className="mb-[5px] opacity-50">
                Showing {filteredCharacter.length}{" "}
                {location.pathname.split("/")[2]}
              </p>
            </div>
            <div
              data-aos="fade-right"
              data-aos-duration="1000"
              className="mt-4 w-full flex flex-row max-xs:flex-col justify-start items-center max-xs:items-start gap-4 max-2xl:flex-wrap"
            >
            ...
            <div
              data-aos="fade-up"
              data-aos-duration="1000"
              className="mt-4 grid grid-cols-8 max-2xl:grid-cols-7 max-xl:grid-cols-6 max-lg:grid-cols-5 max-md:grid-cols-4 max-sm:grid-cols-3 max-xs:grid-cols-2 max-mn:grid-cols-1 gap-4"
            >
